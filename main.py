from utils import visualize_points, fill_polygons, find_corner, compute_iou, visualize_predictions, visualize_polygons
...
def main():
    ...
    project = Project('metashape/building_coco/building_coco_project.psx')
    camera_labels = project.cameras_labels
    camera_centers = project.positions
    print(camera_labels)
    print('-'*150)

    print(project.rotations)
    # We now get the image name
    project.visualize_cameras_3D()
...
""" polygons = [[(0,0), (2,3), (4,0)], [(6,0), (8,3), (10,0)], [(0,10), (52,4), (19,0), (4, 4)]]    
    ...
    visualize_points(polygons_filled) 
